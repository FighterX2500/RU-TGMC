...
/obj/item/book/manual/security_space_law
	...
	desc = "A set of Weyland-Yutani guidelines for keeping law and order on their space stations."
...
/obj/item/book/manual/nuclear
	...
	dat = {"<html>
				...
				Hello and thank you for choosing the Syndicate for your nuclear information needs. Today's crash course will deal with the operation of a Fusion Class Weyland-Yutani made Nuclear Device.<br><br>
				...
				Intelligence Analysts believe that normal Weyland-Yutani procedure is for the Captain to secure the nuclear authentication disk.<br><br>
