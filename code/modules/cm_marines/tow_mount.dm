...
/obj/machinery/m8_1_tow/proc/muzzle_flash(var/angle) // Might as well keep this too.
	...
	if(prob(65))
		...
		//var/image/I = new Type(/image/, list('icons/obj/items/projectiles.dmi', src, "muzzle_flash",img_layer))
		var/image/I = new /image/( list('icons/obj/items/projectiles.dmi', src, "muzzle_flash",img_layer))
