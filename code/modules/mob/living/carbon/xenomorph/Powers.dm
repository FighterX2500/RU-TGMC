...
/proc/check_hive_status(mob/living/carbon/Xenomorph/user, var/anchored = FALSE)
	...
	dat += "<b>Tier 3: [boiler_count + crusher_count + praetorian_count + ravager_count + psyalien_count + defiler_count] Sisters</b> | Boilers: [boiler_count] | Crushers: [crusher_count] | Praetorians: [praetorian_count] | Ravagers: [ravager_count] | PsyAlien: [psyalien_count] | Defilers: [defiler_count]<BR>"
