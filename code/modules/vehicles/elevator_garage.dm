...
/obj/machinery/computer/vehicle_terminal
	...
	var/list/vendor_role = list("Armor Crewman") //everyone else, mind your business

	var/obj/effect/elevator_garage/elevator

/obj/machinery/computer/vehicle_terminal/New()
	..()

	for(var/obj/effect/elevator_garage/EG in orange(2, src))
		elevator = EG
...
/obj/machinery/computer/vehicle_terminal/attack_hand(mob/user)
